...
class DiretoList extends StatefulWidget {
  final List<Video> videos;

  const DiretoList({Key? key, required this.videos}) : super(key: key);

  @override
  _DirectListState createState() => _DirectListState();
}

class _DirectListState extends State<DiretoList> {
  int? _visibleOptionsIndex; // Controla qual item está com opções visíveis
